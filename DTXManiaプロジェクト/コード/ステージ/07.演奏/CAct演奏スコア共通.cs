                    ...
                    if( this.stFont[ i ].ch == ch )
                    {
                        ...
                        switch( mode )
                        {
                            case 0:
                                ...
                                {
                                    CDTXMania.Tx.Taiko_Score[0].color4 = CDTXMania.Skin.cScoreColor;
                            ...
                            case 1:
                                if(CDTXMania.Tx.Taiko_Score[0] != null )
                                {
                                    CDTXMania.Tx.Taiko_Score[0].color4 = CDTXMania.Skin.cScoreColor1P;
                                    CDTXMania.Tx.Taiko_Score[0].n透明度 = alpha;
                            ...
                            case 2:
                                if(CDTXMania.Tx.Taiko_Score[0] != null )
                                {
                                    CDTXMania.Tx.Taiko_Score[0].color4 = CDTXMania.Skin.cScoreColor2P;
                                    CDTXMania.Tx.Taiko_Score[0].n透明度 = alpha;
                                    CDTXMania.Tx.Taiko_Score[0].vc拡大縮小倍率.Y = 1;
                                    CDTXMania.Tx.Taiko_Score[0].t2D拡大率考慮下基準描画( CDTXMania.app.Device, x, y, rectangle );
                                }
