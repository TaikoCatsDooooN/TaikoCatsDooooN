...
//						Trace.TraceInformation( "DTXMania Title: SPACE key registered. " + CDTXMania.ct.nシステム時刻 );
                ...
                strVersion += "  DEBUG";
#endif
                CDTXMania.act文字コンソール.tPrint(4, 4, C文字コンソール.Eフォント種別.白, asmApp.Name + " Ver." + CDTXMania.VERSION + "(TaikoCatsDooooN-Dev Team)");
                ...
                CDTXMania.act文字コンソール.tPrint(4, (720 - 24), C文字コンソール.Eフォント種別.白, "TaikoCatsDooooN forked TJAPlayer3(AioiLight)");
                #endregion
